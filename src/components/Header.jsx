  ...
  return (
    <div className=" bg-[url('Images/pinckbgimghedar.jpeg')] bg-no-repeat bg-cover bg-center  h-auto    ">
      <div className="w-full sm:flex sm:justify-between sm:p-6 ">
        ...
        <div
          className={`flex sm:flex-row justify-start  text-[#110c2e] sm:mt-0 flex-col p-10 font-serif   ${
              ...
              {menuItem.linkTo ? (
                ...
                <div>
                  ...
                  {subMenuOpen && menuItem.subMenu && (
                    <div
                      className={`relative bg-yellow-50  text-red-950  left-0  ${
                    ...
                    >
                      {menuItem.subMenu.map((submenuItem, index) => (
                        <Link
                          ...
                          key={index}
                          className="block py-2 font-bold w-full text-center hover:border-b-2  hover:-translate-y-2 hover:text-xl  border-y-white sm:text-black hover:text-red-600 mr-10 text-sm sm:text-base  hover:opacity-90 "
                        >
                          {submenuItem.title}
                        </Link>
                      ))}
